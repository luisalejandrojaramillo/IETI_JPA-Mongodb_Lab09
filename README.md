...
Este es un metodo implementado por el Spring Repository
...
Two (2) Productos, esta es una paginacion y retorna paginas de 2 productos.

* Which are the collection names where the objects are stored? Where are those names assigned?

Customer and Product, estos nombres se asignan por defecto, para que no sea asi, debemos especificarlo con una etiqueta.
```
